...
representing the project include using an official project account, posting via
...
reported to the project maintainer using a private contact method listed on the
maintainer's GitHub profile. Do not report sensitive conduct matters in a public
issue or discussion.
